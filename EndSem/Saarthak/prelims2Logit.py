...
# Saving the model
try:
	lr_model.save("gs://ctpnet/LR_TFIDF_logit_model12")
except:
	model = lr_model.stages[2]
	print(model)
	model.save("gs://ctpnet/LR_TFIDF_logit_model2")
...
print("Evaluating on Training data Logit:", lr_evaluator.evaluate(prediction_train))
...
print("Evaluating on Test data Logit:", lr_evaluator.evaluate(prediction_test))
