...
yelp_dataset = yelp_dataset.withColumn("label", yelp_dataset["stars"])
# Pipeline
...
# Saving the model
try:
	lr_model.save("gs://ctpnet/LR_TFIDF_naive_bayes_model1")
except:
	model = lr_model.stages[2]
	print(model)
	model.save("gs://ctpnet/LR_TFIDF_naive_bayes_model1")
...
print("Evaluating on Training data NB:", lr_evaluator.evaluate(prediction_train))
...
print("Evaluating on Test data NB:", lr_evaluator.evaluate(prediction_test))
